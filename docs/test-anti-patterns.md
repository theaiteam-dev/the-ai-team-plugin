...
This document catalogs every anti-pattern found during a test suite audit of the Arcane Layer Storefront project (`/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/`). **These are mandatory rules.** Any test agent that generates tests matching these patterns is producing waste, not coverage.

**Origin:** Audit of 51 test files / 2,287 tests. Approximately 40-50% were identified as no-value or low-value, generated by AI agents optimizing for test count rather than regression protection.
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/VariantGridVisual.test.tsx` (entire 1025-line file — every test is this pattern)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/PDPResponsive.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/CartLineItemCard.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/ProductCard.test.tsx`
- Approximately 20 files total
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/CartEmpty.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/OrderSummary.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/FreeShippingBanner.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/CartRecommendations.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/CartLineItemCard.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/Hero.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/Footer.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/cart.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/collections.all.test.tsx`
...
- The negative check (`not.toMatch(/bg-gray-/)`) fires **false positives** on legitimate intentional gray usage (e.g., override for a third-party component) and **false negatives** if violations are in CSS-in-JS, computed styles, or child components that aren't rendered in the mock.
...
it('should fetch search results by query parameter', () => {
  expect(mockSearchLoaderData.term).toBe('dragon');
  expect(mockSearchLoaderData.result.total).toBe(5);
});
```

**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/collections.$handle.test.tsx` (WI-308 Loader section, lines ~994-1048)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/search.test.tsx` (WI-309 Loader section, lines ~1018-1378)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/_index.test.tsx` (Adapter Usage section)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/products.$handle.test.tsx` (Adapter Usage section)
...
it('should retain Analytics.ProductView', async () => {
  const module = await import('~/routes/($locale).products.$handle');
  const source = module.default.toString();

  expect(source).toContain('Analytics.ProductView');
});
```

**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/_index.test.tsx` (lines ~1051-1141)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/products.$handle.test.tsx` (lines ~1097-1521)
...
it('should use variant="secondary" for filter badges', async () => {
  await renderShopPage();
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/collections.all.test.tsx` (approximately 12+ instances at lines 438, 511, 589, 596, 603, 610, 617, 623, 629, 647, 662, 719)
...
- Some even call `renderShopPage()` before the noop assertion, wasting test runtime for nothing.
...
it('should display 30 day returns text', () => {
  render(<TrustBadges />);
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/TrustBadgesPDP.test.tsx` (entire file — real component never imported)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/AddToCartPDP.test.tsx` (Dark Mode section)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/search.test.tsx` (Analytics section)

### Why it's worthless

- You're testing code you just wrote in the test file. The actual production component (`TrustBadgesPDP`) is never imported, never rendered, never tested.
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/types/__tests__/storefront.test.ts` (entire file — 57 tests, all this pattern)

### Why it's worthless

- TypeScript already catches these at compile time. If `Product` doesn't exist or `title` isn't a `string`, `tsc` fails. Running `pnpm typecheck` covers this.
...
Nothing. Run `pnpm typecheck` in CI. That's it. If you want to verify type exports specifically, a single `import type { Product } from '~/types'` at the top of a test file will fail compilation if the type doesn't exist.
...
it('should have app/root.tsx', () => {
  expect(existsSync(join(rootDir, 'app', 'root.tsx'))).toBe(true);
});
```

**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/__tests__/scaffold.test.ts` (entire file — 12 tests)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/__tests__/root.test.tsx` (File Structure section)
...
- These inflate test count (12 tests in this file) while catching exactly zero real bugs.
...
it('should NOT contain .footer-menu selector', () => {
  expect(cssContent).not.toMatch(/\.footer-menu/);
});
```

**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/styles/__tests__/css-cleanup.test.ts` (entire file — 71 tests)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/styles/__tests__/design-token-audit.test.ts` (entire file — 32 tests)
...
it('should have meta function', async () => {
  const { meta } = await import('~/routes/($locale).cart');
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/__tests__/root.test.tsx` (Root Module Exports section)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/_index.test.tsx` (lines ~1018-1103)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/cart.test.tsx` (lines ~676-733)
- Scattered across many route test files
...
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/PDPResponsive.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/collections.all.test.tsx`
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/PageLayout.test.tsx`
...
**Real examples found in:**
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/styles/__tests__/animations.test.ts` (Component Animation Classes section)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/__tests__/root.test.tsx` (reads source files with `fs.readFileSync`)
...
Render the component and test the behavior. If you need to verify animation classes are applied, test with Playwright and actually observe the animation (or at minimum, render and check the element's className — but even that is Anti-Pattern 1).
...
Reference these files as examples of well-written tests:
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/lib/__tests__/adapters.test.ts` — pure function tests with realistic data, edge cases, both connection formats
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/lib/__tests__/structured-data.test.ts` — verifies JSON-LD output fields with real product objects
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/sitemap.test.ts` — pure function tests for XML generation with comprehensive assertions
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/lib/__tests__/consent.test.ts` — behavioral tests for consent state management
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/lib/__tests__/image.test.ts` — URL transformation utility tests with deterministic outputs
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/SearchEdgeCases.test.tsx` — edge case tests (XSS, long strings, special chars, empty input)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/SearchPageInput.test.tsx` — interaction tests (typing, submitting, clearing)
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/components/__tests__/ConsentBanner.test.tsx` — real user interaction tests with correct API call verification
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/analytics/__tests__/PlausibleAnalytics.test.tsx` — utility function tests + consent gating + graceful degradation
- `/Users/josh/Code/ArcaneLayers/store/arcane-layer-storefront/app/routes/__tests__/root.test.tsx` — integration tests for component ordering and conditional rendering
