 ...
 */
export function computeMemoryBudget(freeMemMB, mbPerAgent = MB_PER_AGENT) {
    const availableMB = freeMemMB ?? freemem() / 1024 / 1024;
    const ceiling = Math.floor((availableMB * MEMORY_SAFETY_FACTOR) / mbPerAgent / PIPELINE_AGENT_TYPES);
